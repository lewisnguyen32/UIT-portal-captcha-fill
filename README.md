...
* **Xác định form chính xác:** Định vị và chỉ tương tác trong phạm vi form chứa captcha (form Đăng nhập), hoàn toàn không ảnh hưởng hay click nhầm sang các form khác trên trang web (như form Tìm kiếm từ khóa ở phần nội dung chính).
